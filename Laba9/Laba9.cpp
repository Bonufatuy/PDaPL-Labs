...
int main() {
    cook::Algoritms alg;
    std::list<cook::Death_Stranding> test;
    std::list<cook::Death_Stranding> test_new;

    test.push_back(cook::Death_Stranding(15, 15, 11));
    test.push_back(cook::Death_Stranding(15, 15, 11));
    test.push_back(cook::Death_Stranding(15, 15, 10));

    test_new.push_back(cook::Death_Stranding(15, 15, 11));
    test_new.push_back(cook::Death_Stranding(15, 15, 11));
    test_new.push_back(cook::Death_Stranding(15, 15, 10));
...
void cook::Algoritms::Print(std::list<Death_Stranding>::iterator begin,
...
void cook::Algoritms::Algoritm3(std::list<Death_Stranding>::iterator begin_1, std::list<Death_Stranding>::iterator end_1,
    std::list<Death_Stranding>::iterator begin_2, std::list<Death_Stranding>::iterator end_2) {
    auto it_1 = begin_1;
    auto it_2 = begin_2;
...
std::list<cook::Death_Stranding>::iterator cook::Algoritms::Algoritm2(std::list<Death_Stranding>::iterator begin_1, std::list<Death_Stranding>::iterator end_1,
    std::list<Death_Stranding>::iterator begin_2, std::list<Death_Stranding>::iterator end_2) {
    auto it_1 = begin_1;
    auto it_2 = begin_2;
    while (it_1 != end_1 && it_2 != end_2) {
